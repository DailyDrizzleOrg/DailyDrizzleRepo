...
import com.project.dailydrizzle.adapters.TabVideoAdapter;
...
/**
 * Created by Neeraj on 08,October,2020
 */
public class TabFragment extends Fragment {
    View view;

    public static TabFragment newInstance(int val, ArrayList<Category> categoryList) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        for (int i = 0; i < videoArrayList.size(); i++) {
            ...
            MediaObject mediaObject = new MediaObject(video.getTitle(), video.getVideoUrl(), video.getThumbnail(), video.getDesc());
    ...
    private RequestManager initGlide() {
        RequestOptions options = new RequestOptions()
                .placeholder(R.drawable.thumbs_bg)
                .error(R.drawable.thumbs_bg);

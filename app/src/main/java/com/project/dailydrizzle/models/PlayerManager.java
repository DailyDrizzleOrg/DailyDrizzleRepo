 ...
 */
/* package */ public class PlayerManager implements EventListener, SessionAvailabilityListener {
    ...
    private void setCurrentItem(int itemIndex, long positionMs, boolean playWhenReady) {
        ...
        if (currentPlayer == castPlayer && castPlayer.getCurrentTimeline().isEmpty()) {
            ...
            // currentPlayer.prepare(concatenatingMediaSource);
            // player.seekTo((int) playbackPosition, C.TIME_UNSET);
            exoPlayer.prepare(concatenatingMediaSource);

            exoPlayer.seekTo(itemIndex, positionMs);
